...
public:
    ...
    ManageMenu()
    {
        system("color 0A"); // change terminal color bg to black, text to light green
...
public:
    ...
    void hotels()
    {
        string hotelNo[] = {"Hotel Kashish", "DGS Guest House", "Sundaram Hall"};
        for (int a = 0; a < 3; a++)
        {
        ...
        if (choiceHotel == 1)
        {
            ...
            cout << "\tLive a Luxury at Hotel Kashish: Rs.1500.00" << endl;
            ...
            {
                hotelCost = 500.00;
                cout << "\nYou have successfully booked Standard Pack at Hotel Kashish" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else if (packChoice1 == 2)
            {
                hotelCost = 1000.00;
                cout << "\nYou have successfully booked Premium Pack at Hotel Kashish" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else if (packChoice1 == 3)
            {
                hotelCost = 1500.00;
                cout << "\nYou have successfully booked Luxury Pack at Hotel Kashish" << endl;
                cout << "Goto Menu to take the receipt" << endl;
            }
            else
            {
